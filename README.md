...
* **RFID Integration**: Implementation of RFID sensors to detect vehicle presence and prioritize emergency or heavy-traffic lanes.
...
* Developing the **active-high** LED interface logic for the traffic signals.
* Configuring the **STM32 MCU** to interface with RFID sensors for real-time vehicle detection.
* Debugging state-machine logic for the simulation.
